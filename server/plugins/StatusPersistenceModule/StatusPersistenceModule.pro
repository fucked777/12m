...
include($$BUSINESS_INCLUDE_DIR/StatusHistory/StatusHistorySql.pri)
#include($$BUSINESS_INCLUDE_DIR/DeviceStatusLogModule/DeviceStatusLogModule.pri)
include($$PWD/StatusPersistenceModule/StatusPersistenceModule.pri)
