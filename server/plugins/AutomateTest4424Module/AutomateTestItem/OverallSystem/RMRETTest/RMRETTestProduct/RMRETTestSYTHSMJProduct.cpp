...
RMRETTestSYTHSMJProduct::RMRETTestSYTHSMJProduct(AutomateTestBase* autotestbase)
    : RMRETTestBase(autotestbase)
{
}

bool RMRETTestSYTHSMJProduct::setBaseCmd()
{
...
bool RMRETTestSYTHSMJProduct::startTest(CmdResult& cmdResult)
{
    SingleCommandHelper singleCmdHelper;
    PackCommand packCommand;
