...
RMRETTestSYTHGMLProduct::RMRETTestSYTHGMLProduct(AutomateTestBase* autotestbase)
    : RMRETTestBase(autotestbase)
{
}

bool RMRETTestSYTHGMLProduct::setBaseCmd()
{
...
bool RMRETTestSYTHGMLProduct::startTest(CmdResult& cmdResult)
{
    SingleCommandHelper singleCmdHelper;
    PackCommand packCommand;
