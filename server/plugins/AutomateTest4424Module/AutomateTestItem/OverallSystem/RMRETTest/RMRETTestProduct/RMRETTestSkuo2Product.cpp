...
RMRETTestSkuo2Product::RMRETTestSkuo2Product(AutomateTestBase* autotestbase)
    : RMRETTestBase(autotestbase)
{
}

bool RMRETTestSkuo2Product::setBaseCmd()
{
...
bool RMRETTestSkuo2Product::startTest(CmdResult& cmdResult)
{
    SingleCommandHelper singleCmdHelper;
    PackCommand packCommand;
