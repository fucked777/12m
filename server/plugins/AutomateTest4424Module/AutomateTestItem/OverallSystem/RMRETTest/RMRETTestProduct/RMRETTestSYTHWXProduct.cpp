...
RMRETTestSYTHWXProduct::RMRETTestSYTHWXProduct(AutomateTestBase* autotestbase)
    : RMRETTestBase(autotestbase)
{
}

bool RMRETTestSYTHWXProduct::setBaseCmd()
{
...
bool RMRETTestSYTHWXProduct::startTest(CmdResult& cmdResult)
{
    SingleCommandHelper singleCmdHelper;
    PackCommand packCommand;
