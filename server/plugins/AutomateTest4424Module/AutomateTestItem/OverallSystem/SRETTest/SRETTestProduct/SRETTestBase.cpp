...
SRETTestBase::SRETTestBase(AutomateTestBase* autotestbase) { m_autoTestBase = autotestbase; }

bool SRETTestBase::setLoop()
{
...
bool SRETTestBase::saveResult(const CmdResult cmdResult)
{
