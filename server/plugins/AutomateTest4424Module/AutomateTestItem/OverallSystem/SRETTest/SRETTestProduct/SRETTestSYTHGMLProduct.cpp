#include "SRETTestSYTHGMLProduct.h"

SRETTestSYTHGMLProduct::SRETTestSYTHGMLProduct(AutomateTestBase* autotestbase)
    : SRETTestBase(autotestbase)
{
}

bool SRETTestSYTHGMLProduct::setBaseCmd()
{
...
bool SRETTestSYTHGMLProduct::startTest(CmdResult& cmdResult)
{
    SingleCommandHelper singleCmdHelper;
    PackCommand packCommand;
    ...
    singleCmdHelper.packSingleCommand(QString("StepCKJD_SYTHGML_AUTOTESTRMRET"), packCommand, m_ckjd, replaceParamMap);
