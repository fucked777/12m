#include "SRETTestSTTCProduct.h"

SRETTestSTTCProduct::SRETTestSTTCProduct(AutomateTestBase* autotestbase)
    : SRETTestBase(autotestbase)
{
}

bool SRETTestSTTCProduct::setBaseCmd()
{
...
bool SRETTestSTTCProduct::startTest(CmdResult& cmdResult)
{
    SingleCommandHelper singleCmdHelper;
    PackCommand packCommand;
