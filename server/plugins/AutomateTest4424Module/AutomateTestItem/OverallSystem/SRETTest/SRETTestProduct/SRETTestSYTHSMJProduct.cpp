#include "SRETTestSYTHSMJProduct.h"

SRETTestSYTHSMJProduct::SRETTestSYTHSMJProduct(AutomateTestBase* autotestbase)
    : SRETTestBase(autotestbase)
{
}

bool SRETTestSYTHSMJProduct::setBaseCmd()
{
     ...
     */
    singleCmdHelper.packSingleCommand("StepCKJD_SYTHSMJ_TU_AUTOTEST_Code", packCommand, m_ckjd);
     ...
     */
    singleCmdHelper.packSingleCommand("StepCKJD_SYTHSMJ_TAS_AUTOTEST_Code", packCommand, m_ckjd);
    ...
    /*中频调制单元加调*/
    singleCmdHelper.packSingleCommand("StepCKJD_SYTHSMJ_JTKZ_AUTOTEST", packCommand, m_ckjd);
    execStatus = m_autoTestBase->waitExecSuccess(packCommand, 40);
    if (execStatus != AutomateTestBase::ExecStatus::Success)
    {
        return false;
...
bool SRETTestSYTHSMJProduct::startTest(CmdResult& cmdResult)
{
    SingleCommandHelper singleCmdHelper;
    PackCommand packCommand;
    ...
    singleCmdHelper.packSingleCommand(QString("StepCKJD_SYTHSMJ_AUTOTESTRMRET"), packCommand, m_ckjd, replaceParamMap);
