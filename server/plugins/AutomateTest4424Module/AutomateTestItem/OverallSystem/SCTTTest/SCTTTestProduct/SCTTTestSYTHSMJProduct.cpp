...
SCTTTestSYTHSMJProduct::SCTTTestSYTHSMJProduct(AutomateTestBase* autotestbase)
    : SCTTTestBase(autotestbase)
{
}

bool SCTTTestSYTHSMJProduct::setBaseCmd()
{
...
bool SCTTTestSYTHSMJProduct::startTest(CmdResult& cmdResult)
{
    SingleCommandHelper singleCmdHelper;
    PackCommand packCommand;
     ...
     * 这里错误直接就返回错误就行了
     */
    singleCmdHelper.packSingleCommand(QString("StepCKJD_SYTHSMJ_AUTOTESTSCTT"), packCommand, m_ckjd, replaceParamMap);
