...
SCTTTestSYTHWXProduct::SCTTTestSYTHWXProduct(AutomateTestBase* autotestbase)
    : SCTTTestBase(autotestbase)
{
}

bool SCTTTestSYTHWXProduct::setBaseCmd()
{
...
bool SCTTTestSYTHWXProduct::startTest(CmdResult& cmdResult)
{
    SingleCommandHelper singleCmdHelper;
    PackCommand packCommand;
     ...
     * 这里错误直接就返回错误就行了
     */
    singleCmdHelper.packSingleCommand(QString("StepCKJD_SYTHWX_AUTOTESTSCTT"), packCommand, m_ckjd, replaceParamMap);
