...
!equals(SqlGlobalDataSqlPri,$${TARGET}SqlGlobalDataSqlPri){
    SqlGlobalDataSqlPri = $${TARGET}SqlGlobalDataSqlPri
...
SOURCES += \
    $$PWD/Activator.cpp \
    $$PWD/AutorunPolicy.cpp \
    $$PWD/SqlAutorunPolicy.cpp

HEADERS += \
    $$PWD/AutorunPolicy.h \
    $$PWD/SqlAutorunPolicy.h
