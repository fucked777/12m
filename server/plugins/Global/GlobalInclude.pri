...
# 设备组合号
!equals(DevNumberPri,$${TARGET}DevNumberPri){
    DevNumberPri = $${TARGET}DevNumberPri
    include($$PWD/DevNumber/DevNumberInclude.pri)
}


# 链路配置
!equals(LinkConfigHelperPri,$${TARGET}LinkConfigHelperPri){
    LinkConfigHelperPri = $${TARGET}LinkConfigHelperPri
    include($$PWD/LinkConfigHelper/LinkConfigHelperInclude.pri)
}

# 命令读取与发送
!equals(SingleCommandHelperPri,$${TARGET}SingleCommandHelperPri){
    SingleCommandHelperPri = $${TARGET}SingleCommandHelperPri
    include($$PWD/SingleCommandHelper/SingleCommandHelperInclude.pri)
}


# 组包
!equals(PacketHandlerPri,$${TARGET}PacketHandlerPri){
    PacketHandlerPri = $${TARGET}PacketHandlerPri
    include($$PWD/PacketHandler/PacketHandlerInclude.pri)
}
...
!equals(PDXPPri,$${TARGET}PDXPPri){
    ...
    include($$PWD/PDXP/PDXPInclude.pri)
}
