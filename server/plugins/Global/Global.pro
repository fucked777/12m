...
!equals(DevNumberPri,$${TARGET}DevNumberPri){
    ...
    include($$PWD/DevNumber/DevNumber.pri)
}
...
!equals(PacketHandlerPri,$${TARGET}PacketHandlerPri){
    ...
    include($$PWD/PacketHandler/PacketHandler.pri)
}
...
!equals(PhaseCalibrationPri,$${TARGET}PhaseCalibrationPri){
    ...
    include($$PWD/PhaseCalibration/PhaseCalibration.pri)
}
