...
public:
    ...
    void doSomething();
    // 基带开启存盘 送数
    void deviceTaskStart(const TaskTimeList& taskTimeList);
    void ckTaskStart(const TaskTimeList& taskTimeList);
    // ACU 任务开始
    void acuTaskStart(const TaskTimeList& taskTimeList);
    // DTE 任务开始
    // void dteTaskStart(const TaskTimeList& taskTimeList);
