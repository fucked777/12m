...
#DEFINES += TEST_MASTER_SLAVE

DESTDIR = $$PLUGIN_DIR

SOURCES += \
    $$PWD/Activator.cpp \
    $$PWD/HeartbeatThread.cpp \
    $$PWD/HeartBeatXMLReader.cpp \
    $$PWD/HaSwitchWidget.cpp


HEADERS += \
    $$PWD/HeartbeatThread.h \
    $$PWD/HeartBeatXMLReader.h \
    $$PWD/HaSwitchWidget.h
