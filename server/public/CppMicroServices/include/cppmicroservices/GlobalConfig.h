...
/* #undef US_ENABLE_THREADING_SUPPORT */
#define US_HAVE_VISIBILITY_ATTRIBUTE

#define US_DEBUG_POSTFIX "d"
...
#define CppMicroServices_VERSION_MAJOR 3
#define CppMicroServices_VERSION_MINOR 3
#define CppMicroServices_VERSION_PATCH 0
#define CppMicroServices_VERSION 3.3.0
#define CppMicroServices_VERSION_STR "3.3.0"

#define US_VERSION_MAJOR 3
#define US_VERSION_MINOR 3
#define US_VERSION_PATCH 0
#define US_VERSION 3.3.0
#define US_VERSION_STR "3.3.0"
