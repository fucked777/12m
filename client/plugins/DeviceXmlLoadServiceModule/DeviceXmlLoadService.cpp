...
void DeviceXmlLoadService::loadDeviceXMLConfig()
{
    ...
    DeviceControlXMLReader deviceControlxml;
    ...
    filePath = QString("%1/DeviceControlLayout.xml").arg(deviceXmlDir);
    deviceControlxml.loadControlAlignmentXML(filePath, controlAlignment);
    //加载系统配置数据
    ...
    GlobalData::setDeviceControlData(controlAlignment);
}
