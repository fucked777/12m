...
void ParamMacroManagerWidget::loadUI()
{
    ...
    connect(ui->checkBtn, &QPushButton::clicked, this, &ParamMacroManagerWidget::slotShowBtnClicked);
...
{
    mImpl->mParamMacroTableModel->clearParamMacroData();

    QMap<QString, QString> data;
    if (!GlobalData::getParamMacroData(data))
    {
        return;
    }
    ...
    for(auto iter = data.begin(); iter != data.end(); ++iter)
    {
        ...
        mImpl->mParamMacroTableModel->addParamMacroData(paramMacroData);
    }
}
