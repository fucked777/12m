...
void RealtimeLogModel::setSystemLogData(const QList<AutoTaskLogData> &systemLogDatas)
{
    beginResetModel();
    mAutoTaskLogData = systemLogDatas;
    endResetModel();
}
...
QList<AutoTaskLogData> RealtimeLogModel::getCurrentLogData()
{
    return mAutoTaskLogData;
}
