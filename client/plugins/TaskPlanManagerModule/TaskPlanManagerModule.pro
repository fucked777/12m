...
!equals(FepSendPri,$${TARGET}FepSendPri){
    FepSendPri = $${TARGET}FepSendPri
    include($$BUSINESS_INCLUDE_DIR/FepSend/FepSend.pri)
}

include($$PWD/TaskPlanManagerModule/TaskPlanManagerModule.pri)
