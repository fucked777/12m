...
include($$PRIVATE_INCLUDE_DIR/Diagram/Diagram.pri)
...
SOURCES += \
    $$PWD/SystemBlockDiagramWidget.cpp  \
    $$PWD/Activator.cpp \
    $$PWD/BlockDiagramDataSource.cpp \
    $$PWD/SystemBlockDiagramService.cpp \
    $$PWD/ItemDefaultDataSetChange.cpp \
    BlockDiagramConfig.cpp \
    BlockDiagramDataSourceThread.cpp

HEADERS += \
    $$PWD/SystemBlockDiagramWidget.h \
    $$PWD/BlockDiagramDataSource.h \
    $$PWD/BlockDiagramDefine.h \
    $$PWD/SystemBlockDiagramService.h \
    $$PWD/ItemDefaultDataSetChange.h \
    BlockDiagramConfig.h \
    BlockDiagramDataSourceThread.h
...
win32{
    ...
    RES_DIR=$${FRAME_DIR}/plugins/$${MODULE_NAME}/resources
