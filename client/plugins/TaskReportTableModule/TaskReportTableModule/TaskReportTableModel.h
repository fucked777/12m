#ifndef TASKREPORTTABLEMODEL_H
#define TASKREPORTTABLEMODEL_H
...
class TaskReportTableModel : public QAbstractTableModel
{
    Q_OBJECT
public:
    enum Column
    ...
    explicit TaskReportTableModel(QObject* parent = nullptr);
    ~TaskReportTableModel();
