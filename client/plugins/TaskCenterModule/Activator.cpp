...
namespace
{
    ...
    private:
        ...
        public:
            ...
            {
                auto taskCenterWidget = new TaskCenter(m_context);
                if (m_context)
                {
                    auto ref = m_context.GetServiceReference<TaskCenterService>();
                    auto service = m_context.GetService(ref);
                    QObject::connect(taskCenterWidget, &TaskCenter::sg_add, service.get(), &TaskCenterService::addItem);
                    QObject::connect(taskCenterWidget, &TaskCenter::sg_delete, service.get(), &TaskCenterService::deleteItem);
                    QObject::connect(taskCenterWidget, &TaskCenter::sg_modify, service.get(), &TaskCenterService::modifyItem);

                    QObject::connect(service.get(), &TaskCenterService::sg_addACK, taskCenterWidget, &TaskCenter::sg_addACK);
                    QObject::connect(service.get(), &TaskCenterService::sg_deleteACK, taskCenterWidget, &TaskCenter::deleteACK);
                    QObject::connect(service.get(), &TaskCenterService::sg_modifyACK, taskCenterWidget, &TaskCenter::sg_modifyACK);
                }
    ...
    public:
        ...
        void Start(BundleContext context)
        {
            ...
            registerNetService<TaskCenterService>(context, "TaskCenterService");
        }
