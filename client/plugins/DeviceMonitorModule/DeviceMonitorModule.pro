...
include($$FRAME_DIR/plugins/DeviceMonitorModule/DeviceMonitorModule/DeviceMonitorModule.pri)
include($$PRIVATE_INCLUDE_DIR/Control.pri)

INCLUDEPATH += $$PWD/DeviceMonitorModule \
...
SOURCES += \
    $$PWD/Activator.cpp \
    $$PWD/DeviceProcessService.cpp \
    CreateMonitorWidget.cpp

HEADERS += \
    $$PWD/DeviceProcessService.h \
    CreateMonitorWidget.h
...
DISTFILES += \
    DeviceMonitorModule/DeviceMonitorModule.pri
