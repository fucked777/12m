    ...
    , ui(new Ui::AntennaControlWidget4426)
{
    ...
    setSettingPanelColor(ui->sTrackBtn);
    setSettingPanelColor(ui->kaYCBtn);
    setSettingPanelColor(ui->kaDataTransTrackBtn);
}
...
void AntennaControlWidget4426::setSettingPanelColor(QWidget* control)
{
    if (control != nullptr)
    {
        control->setStyleSheet(QString(".QPushButton {font:12pt;font-weight:bold;}"));
    }
}
...
void AntennaControlWidget4426::timerEvent(QTimerEvent* /*event*/)
{
    ...
    auto statusReportMsg = GlobalData::getExtenStatusReportDataByObject(useACUID);
