...
namespace
{
    ...
    private:
        ...
        public:
            ...
            {
                auto stationResManagementWidget = new StationResManagement(m_context);

                if (m_context)
                {
                    auto ref = m_context.GetServiceReference<StationResManagementService>();
                    auto service = m_context.GetService(ref);
                    QObject::connect(stationResManagementWidget, &StationResManagement::sg_add, service.get(), &StationResManagementService::addItem);
                    QObject::connect(stationResManagementWidget, &StationResManagement::sg_delete, service.get(),
                                     &StationResManagementService::deleteItem);
                    QObject::connect(stationResManagementWidget, &StationResManagement::sg_modify, service.get(),
                                     &StationResManagementService::modifyItem);

                    QObject::connect(service.get(), &StationResManagementService::sg_addACK, stationResManagementWidget,
                                     &StationResManagement::sg_addACK);
                    QObject::connect(service.get(), &StationResManagementService::sg_deleteACK, stationResManagementWidget,
                                     &StationResManagement::deleteACK);
                    QObject::connect(service.get(), &StationResManagementService::sg_modifyACK, stationResManagementWidget,
                                     &StationResManagement::sg_modifyACK);
                }

                return stationResManagementWidget;
            }
    ...
    public:
        ...
        void Start(BundleContext context)
        {
            ...
            registerNetService<StationResManagementService>(context, "StationResManagementService");
        }
