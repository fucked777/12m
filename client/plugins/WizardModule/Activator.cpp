...
namespace
{
     ...
     */
    class US_ABI_LOCAL WizardModuleActivator : public BundleActivator
    {
    public:
        /**
        ...
        {
            auto guiService = std::make_shared<Wizard>(context);
            ServiceProperties props;
            props["Type"] = std::string("Wizard");
            context.RegisterService<IWizard>(guiService, props);
        }
...
CPPMICROSERVICES_EXPORT_BUNDLE_ACTIVATOR(WizardModuleActivator)
//![Activator]
