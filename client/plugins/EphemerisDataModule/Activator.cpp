...
namespace
{
    ...
    private:
        ...
        public:
            ...
            {
                auto taskCenterWidget = new EphemerisData(m_context);
                if (m_context)
                {
                    auto ref = m_context.GetServiceReference<EphemerisDataService>();
                    auto service = m_context.GetService(ref);
                    QObject::connect(taskCenterWidget, &EphemerisData::sg_add, service.get(), &EphemerisDataService::addItem);
                    QObject::connect(taskCenterWidget, &EphemerisData::sg_delete, service.get(), &EphemerisDataService::deleteItem);
                    QObject::connect(taskCenterWidget, &EphemerisData::sg_modify, service.get(), &EphemerisDataService::modifyItem);

                    QObject::connect(service.get(), &EphemerisDataService::sg_addACK, taskCenterWidget, &EphemerisData::sg_addACK);
                    QObject::connect(service.get(), &EphemerisDataService::sg_deleteACK, taskCenterWidget, &EphemerisData::deleteACK);
                    QObject::connect(service.get(), &EphemerisDataService::sg_modifyACK, taskCenterWidget, &EphemerisData::sg_modifyACK);
                }

                return taskCenterWidget;
            }
    ...
    public:
        ...
        void Start(BundleContext context)
        {
            ...
            registerNetService<EphemerisDataService>(context, "EphemerisDataService");
        }
