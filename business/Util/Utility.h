...
public:
    ...
    /* 统一的tableView样式初始化 */
    static void tableViewInit(QTableView* view, bool enableStretchLastSection = false);
    /* 目录拼接/文件拼接 */
    ...
    /* 时间统一格式化与还原 */
    static QTime timeFromStr(const QString&);
    static QString timeToStr(const QTime&);
    static QString timeToStr();

    static QDate dateFromStr(const QString&);
    static QString dateToStr(const QDate&);
    static QString dateToStr();

    static QDateTime dateTimeFromStr(const QString&);
    static QString dateTimeToStr(const QDateTime&);
    static QString dateTimeToStr();

    /* 创建附加了时间信息的UUid 方便搜索 */
    static QString createTimeUuid();
    static QString createTimeUuid(const QDateTime&);
    /* 与createTimeUuid对应 创建模糊搜索的时间前缀  suffix */
    static QString createTimeSearchPrefix(const QString& suffix = QString());
    static QString createTimeSearchPrefix(const QDateTime&, const QString& suffix = QString());
};
...
public:
    ...
    friend JsonReader& operator&(JsonReader& self, Optional<T>& info)
    {
        self.StartObject();
        self.Member("code") & info.m_errorCode;
        self.Member("message") & info.m_msg;
        self.Member("value") & info.m_value;
        info.m_success = (info.m_errorCode == ErrorCode::Success);
        return self.EndObject();
    }
    friend JsonWriter& operator&(JsonWriter& self, const Optional<T>& info)
    {
        self.StartObject();
        self.Member("code") & info.m_errorCode;
        self.Member("message") & info.m_msg;
    ...
    friend inline QString& operator<<(QString& self, const Optional<T>& value)
    {
        JsonWriter obj;
        obj& value;
        self.append(obj.GetQString());
        return self;
    }
    friend inline QByteArray& operator<<(QByteArray& self, const Optional<T>& value)
    {
        JsonWriter obj;
        obj& value;
        self.append(obj.GetByteArray());
        return self;
    }
    template<typename U>
    friend U& operator>>(U& self, Optional<T>& value)
    {
        JsonReader obj(self);
        obj& value;
        return self;
...
public:
    ...
    friend JsonReader& operator&(JsonReader& self, Optional<void>& info)
    {
        self.StartObject();
        self.Member("code") & info.m_errorCode;
        self.Member("message") & info.m_msg;
    ...
    friend JsonWriter& operator&(JsonWriter& self, const Optional<void>& info)
    {
        self.StartObject();
        self.Member("code") & info.m_errorCode;
        self.Member("message") & info.m_msg;
    ...
    friend inline QString& operator<<(QString& self, const Optional<void>& value)
    {
        JsonWriter obj;
        obj& value;
        self.append(obj.GetQString());
    ...
    friend inline QByteArray& operator<<(QByteArray& self, const Optional<void>& value)
    {
        JsonWriter obj;
        obj& value;
        self.append(obj.GetByteArray());
    ...
    template<typename U>
    friend U& operator>>(U& self, Optional<void>& value)
    {
        JsonReader obj(self);
        obj& value;
        return self;
...
{
public:
    explicit BlockSignalsHelper(QObject* obj)
        : m_obj(obj)
    {
...
public:
    ...
    explicit AtomicFlagHelper(std::atomic_bool& flag)
        : m_flag(flag)
    {
        destroyValue = !flag;
    }
