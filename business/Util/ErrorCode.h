...
#define ERROR_CODE(X)                                                                                                                                \
    ...
    X(InstructionExecutionError, 0x19, "指令执行错误")                                                                                               \
    X(Timeout, 0x1A, "超时")                                                                                                                         \
    X(Busy, 0x1B, "忙")                                                                                                                              \
    X(TestError, 0x1C, "测试错误")                                                                                                                   \
    X(UDPInitFailed, 0x1D, "UDP初始化错误")                                                                                                          \
    X(GetDataFailed, 0x1E, "获取数据失败")                                                                                                           \
    X(SubControl, 0x1F, "设备分控")                                                                                                                  \
    X(ZMQSocketInitFailed, 0x1001, "ZMQSocket初始化失败")                                                                                            \
    X(ZMQConnectFailed, 0x1002, "ZMQSocket连接失败")                                                                                                 \
    X(ZMQBindFailed, 0x1003, "ZMQSocket绑定失败")                                                                                                    \
    X(ZMQContextInitFailed, 0x1004, "ZMQContext初始化失败")                                                                                          \
