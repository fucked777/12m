...
public:
    INetMsg(QObject* parent = nullptr);
    virtual ~INetMsg();
...
signals:
    void sg_internalCall(const SubscribeFunction&, const ProtocolPack&);

private:
    void subscribeCall(const SubscribeFunction&, const ProtocolPack&);
