...
namespace
{
    ...
    private:
        ...
        public:
            ...
            virtual QWidget* createWidget(const QString& /*subWidgetName*/) override { return new MacroServiceManagerDialog(context_); }
    ...
    public:
        ...
        void Start(BundleContext context)
        {
            ...
            props["Type"] = std::string("MicroServiceManagerDialog");
