...
void HP::resetUIData()
{
    ...
    ui->output_S->setCurrentIndex(0);
    ui->alc_S->setCurrentIndex(0);
    ui->toACU_KaCK->setCurrentIndex(0);
    ui->output_KaCK->setCurrentIndex(0);
    ui->alc_KaCK->setCurrentIndex(0);
    ui->toACU_KaSC->setCurrentIndex(0);
    ui->output_KaSC->setCurrentIndex(0);
    ui->alc_KaSC->setCurrentIndex(0);
